...
import { useRecentBookings, useStats } from '@/services/hooks/use-stats.js';
...
export default function DashboardPage() {
  ...
  console.log('stats', { stats, isLoadingStats });
  console.log('recents', { recents, isLoadingRecents });
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-7">
              ...
              <Card className="col-span-4 md:col-span-3">
                <CardHeader>
                  ...
                  <CardDescription>
                    Tienes {stats?.total_bookings_pending ?? 0} reservas
                    pendientes.
                  </CardDescription>
                </CardHeader>
                <CardContent>
