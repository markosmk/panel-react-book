  ...
  users: (props: IconProps) => (
    ...
    >
      <path
        ...
        fill="currentColor"
        fillRule="evenodd"
        d="M6.09 2.735a3.686 3.686 0 0 1 1.316 4.653A4.054 4.054 0 1 0 6.09 2.735Zm3.791 1.066c0.345 0 0.625 0.28 0.625 0.625l0 1.795a0.625 0.625 0 0 1 -1.25 0l0 -1.795c0 -0.345 0.28 -0.625 0.625 -0.625Zm-0.733 -1.58c0 0.471 0.39 0.678 0.665 0.708a0.634 0.634 0 0 0 0.07 0.004c0.273 0 0.734 -0.2 0.734 -0.712 0 -0.472 -0.39 -0.679 -0.665 -0.709a0.633 0.633 0 0 0 -0.07 -0.004c-0.273 0 -0.734 0.2 -0.734 0.713ZM4.065 8.259a2.44 2.44 0 1 0 0 -4.879 2.44 2.44 0 0 0 0 4.879ZM0 13.137a4.065 4.065 0 0 1 8.075 -0.673h5.157a0.75 0.75 0 0 1 0 1.5H0.77a0.75 0.75 0 0 1 -0.748 -0.698 0.406 0.406 0 0 1 -0.021 -0.129Z"
        clipRule="evenodd"
        strokeWidth={1}
      />
    </svg>
