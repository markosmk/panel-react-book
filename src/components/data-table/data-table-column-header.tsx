    ...
    <div className={cn('flex items-center gap-2', className)}>
      ...
      >
        <SelectTrigger
          ...
          className="-ml-3 h-8 w-fit border-none px-2.5 text-xs hover:bg-background data-[state=open]:bg-background data-[state=open]:text-white [&>svg:last-child]:hidden"
        >
