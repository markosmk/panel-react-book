...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        'fixed z-50 w-full max-w-lg border bg-background data-[state=open]:animate-in data-[state=closed]:animate-out sm:rounded-xl',
        // centered,
